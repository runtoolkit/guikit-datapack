...
execute if entity @s[tag=guikit.m.demo_hopper] run function demo:theme/hopper_fill
execute if entity @s[tag=guikit.m.demo_shop] run function demo:theme/shop_fill
